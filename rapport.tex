...
\end{itemize}
\section{Teori}
Detta teoriavsnitt beskriver hur uttryck representeras på ett sätt som är enklare för programmet att hantera samt själva strukturen på programmet. Multinomialsatsen kommer också att gås igenom då den används för att utveckla multinom.
