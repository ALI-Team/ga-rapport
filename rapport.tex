...
\begin{itemize}
	\item Hur kan inmatad data tolkas och representeras som en trädstruktur?
...
>>>>>>> f444193835633dc89b3ef5cbc42c7764ff507378
...
\begin{itemize}
  \item macOS / BSD / Linux / cygwin(Windows) / termux(Android)
  \item Python 3
  \item Purplex
  \item PIL
\end{itemize}
