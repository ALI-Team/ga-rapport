...
\newline
För att tolka ekvationer som är skrivna på vanlig form (e.x. \(5x + 10 = 15\)) måste de representeras med hjälp av en datastruktur. Detta underlettar processen att skriva en tolk som kan fatta strukturen av en ekvation dels hålla reda på ordningen (t.ex. multiplikation går före addition, osv.).
